...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="content">
            ...
            <div class="bg-light rounded py-2 col-8">
                ...
                <div class="px-2 h-100">
                    <div class="d-flex align-items-center justify-content-between m-n2">
                        <div class="row">
                            <a href="./create-goal.php" class="col-2 btn btn-primary m-2 ms-4"><i class="fa fa-plus"></i></a>
        ...
        <div class="modal fade text-start" id="editGoalModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="col-12">
                    ...
                    <div class="modal-content">
                        <div class="bg-light rounded h-100 p-4">
                            <div class="d-flex">
                                <a class="ps-5 pe-3" href="./goals.php"><i class="fa fa-arrow-left"></i></a>
    ...
    <script>
        function eliminar(id) {
            ...
            fetch('/goally/server/controllers/controllerGoal.php', {
                    "method": 'POST',
                    "headers": {
                ...
                .then(dat => {
                    setTimeout(() => {
                        window.location.href = "/accountly/src/goals.php";
                    }, 1500);
                    console.log(dat)
                })
        }
    ...
    <script src="./assets/js/validate-edit-goal.js"></script>
