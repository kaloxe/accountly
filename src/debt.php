...
<div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <div class="bg-light rounded py-2 col-8">
                ...
                <div class="px-2 h-100">
                    <div class="d-flex align-items-center justify-content-between m-n2">
                        <div class="row">
                            <a href="./create-debt.php" class="col-2 btn btn-primary m-2 ms-4"><i class="fa fa-plus"></i></a>
    ...
    <div class="modal fade text-start" id="editDebtModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="bg-light rounded h-100 p-4">
                        <div class="d-flex">
                            ...
                            <h6 class="mb-4">Actualizar deuda</h6>
                        </div>
...
<script src="./assets/js/validate-edit-debt.js"></script>
