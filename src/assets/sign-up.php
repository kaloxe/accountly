            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                ...
                <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                    ...
                    <form id="formulario">
                        ...
                        <div class="form-floating mb-2" id="grupo__password2">
                            <input type="password" class="form-control formulario__grupo-input formulario__input" name="password2" id="password2" placeholder="">
                            <label for="password2">Repita contraseña</label>
                            <p class="formulario__input-error">Ambas contraseñas deben ser iguales.</p>
                        </div>

                        <div class="formulario__grupo formulario__grupo-btn-enviar mt-4">
                            <input type="button" class="btn btn-primary py-3 w-100 mb-2" id="submit" value="Actualizar">
