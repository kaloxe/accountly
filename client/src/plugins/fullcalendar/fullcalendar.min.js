        ...
        H = (function () {
          ...
          return (
            ...
            (t.prototype.bindViewHandlers = function (t) {
              var e = this;
              //punto clave para titulo del mes
              t.watch("titleForCalendar", ["title"], function (n) {
                let regexAno = /(\d+)/g;
                let regexMes = /(\w+)/g;
                let name = n.title;
                let ano = name.match(regexAno);
                let mes = name.match(regexMes);
                let fecha = "";
                switch (mes[0]) {
                  case "January":
                    fecha = "Enero " + ano[0];
                  ...
                  case "August":
                    ...
                    break;
                  case "September":
                    fecha = "Septiembre " + ano[0];
                    break;
                  case "October":
                    fecha = "Octubre " + ano[0];
                    break;
                  case "November":
                    fecha = "Noviembre " + ano[0];
                    break;
                  case "December":
                    fecha = "Diciembre " + ano[0];
                  break;
                  default:
                    fecha = n.title;
                }
                ...
                t === e.view && e.setToolbarsTitle(fecha);
                //console.log(n.title);
                // console.log(t);
                // console.log(e.view);
              }),
              ...
              t
                ? (e
                  ...
                  e
                    ...
                    .append(this.renderSection('center" hidden'))
