...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->setXY(60, 15);
		$this->Cell(100, 8, 'Saldo en dolar', 0, 1, 'C', 0);
...
$pdf->Cell(60, 8, 'Deposito', 1, 0, 'C', 0);
$pdf->Cell(70, 8, 'Monto', 1, 1, 'C', 0);
...
for ($i = 0; $i < count($data); $i++) {
	...
	$pdf->Row(array($data[$i]['name_font'], $data[$i]['amount']), 45);
}
