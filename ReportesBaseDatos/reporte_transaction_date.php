...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->setXY(60, 15);
		$this->Cell(100, 8, 'Reporte de transacciones', 0, 1, 'C', 0);
...
if ($_SESSION["cuenta"] == null || $_SESSION["cuenta"] == "0") {
	$sql = "SELECT * FROM transaction INNER JOIN font on font.id_font=transaction.id_font WHERE (date BETWEEN '" . $_SESSION["fecha_inicial"] ."' and '" . $_SESSION["fecha_final"] . "') AND id_user=$id_user";
	$sql1 = "SELECT count(id_transaction) as count FROM transaction INNER JOIN font on font.id_font=transaction.id_font WHERE (date BETWEEN '" . $_SESSION["fecha_inicial"] ."' and '" . $_SESSION["fecha_final"] . "') AND id_user=$id_user";
} else {
	$sql = "SELECT * FROM transaction INNER JOIN font on font.id_font=transaction.id_font WHERE id_management='" . $_SESSION["cuenta"] ."' and (date BETWEEN '" . $_SESSION["fecha_inicial"] ."' and '" . $_SESSION["fecha_final"] . "') AND id_user=$id_user";
	$sql1 = "SELECT count(id_transaction) as count FROM transaction INNER JOIN font on font.id_font=transaction.id_font WHERE id_management='" . $_SESSION["cuenta"] ."' and (date BETWEEN '" . $_SESSION["fecha_inicial"] ."' and '" . $_SESSION["fecha_final"] . "') AND id_user=$id_user";
}
