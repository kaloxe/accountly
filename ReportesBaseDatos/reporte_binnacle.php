...
class PDF extends FPDF
{
	...
	function Header()
	{
		...
		$this->setXY(60, 15);
		$this->Cell(100, 8, 'Bitacora', 0, 1, 'C', 0);
...
$strquery = "SELECT * FROM binnacle WHERE id_user=$id_user";
...
$sql1 = "SELECT COUNT(id_binnacle) as count FROM binnacle WHERE id_user=$id_user";
...
$pdf->Cell(60, 8, 'Movimiento', 1, 0, 'C', 0);
$pdf->Cell(80, 8, 'Fecha', 1, 1, 'C', 0);
...
for ($i = 0; $i < count($data); $i++) {
	...
	$pdf->Row(array($data[$i]['movement'], $data[$i]['datetime']), 35);
}
